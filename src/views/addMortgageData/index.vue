<template>
  <section class="mod-addMortgageData">
    ...
    <div class="mod-module">
      <div class="subtitle">一期</div>
      <div class="mod-form">
        <div class="verify">
          <label for="username">*全款</label>
          <input class="verify-input" placeholder="请输入数量" type="text" name="username">数
          <input class="verify-input" placeholder="请输入金额" type="text" name="username">万元
        </div>
        <div class="verify">
    ...
    <van-button type="default" style="margin: 30px 0px 100px 200px">新增期数</van-button>
